...
static void process_image(const void *p, int size)
{
	...
	/*int file = open("/home/josep/Desktop/out.yuy", O_CREAT | O_TRUNC | O_WRONLY);

	if (file != -1) {
		std::cout << "File opened. \n";
		int result = write(file, p, size);
	} else {
		std::cout << "Nnnnot. \n";
	}*/
...
int main(int argc, char **argv)
{
	...
	int fd0 = stat("/dev/video0", &st);
	ioctl(NULL, VIDIOC_ENUM_FMT, &desc);
